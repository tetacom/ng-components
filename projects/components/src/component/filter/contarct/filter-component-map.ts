...
const filterComponentsMap: Map<FilterType, Type<any>> = new Map<FilterType, Type<any>>()
...
export const getFilterComponent = (item: FilterItem): Type<any> =>
  filterComponentsMap.has(item.filterType) ? filterComponentsMap.get(item.filterType) : StringFilterComponent;
