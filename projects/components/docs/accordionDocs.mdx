...
<div class='column gap-24'>
  ...
  <div class='column'>
    <p>Для начала нужно создать <code> &lt;teta-accordion&gt;</code>, обертка для аккордеонов и служит для объединения аккордеонов, т.е. среди них может быть открыт только один.</p>
