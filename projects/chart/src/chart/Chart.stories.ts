...
import {points1, points2} from '../../../components/src/component/chart/chart-data';
...
export const basicChart = () => ({
  ...
  template: `<div class="font-body-3 padding-3 bg-background-0" style="width: 400px; height: 300px;">
