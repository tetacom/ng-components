import { ChangeDetectionStrategy, Component, CUSTOM_ELEMENTS_SCHEMA, inject, Input, OnDestroy } from '@angular/core';
...
export class Axes3dComponent implements OnDestroy {
  ...
  constructor() {
    this.axes = combineLatest([this.chartService.scales, this.chartService.minMax]).pipe(
